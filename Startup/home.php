...
<body>
    ...
    * {
    ...
    <div class="admin-management">
        <div class="sidebar">
            <img src="..\images\USILogo.png"
                alt="Logo" class="logo" />
            <h2 class="welcome-text">Welcome</h2>
            <div class="menu-container">

                <div onclick="redirectTo('okr-mgt')"
                    class="<?php echo isset($_GET['handle']) && ($_GET['handle'] == 'okr-mgt' || $_GET['handle'] == 'create-cinema' || $_GET['handle'] == 'edit-cinema') || !isset($_GET['handle']) ? 'menu-item menu-item-active' : 'menu-item menu-item-default'; ?>">
                    <div class="menu-item-content">
                        ...
                        <span class="menu-item-text">Danh sách mục tiêu</span>
                    </div>


                </div>

                <div onclick="redirectTo('request-mgt')"
                    class="<?php echo isset($_GET['handle']) && ($_GET['handle'] == 'request-mgt' || $_GET['handle'] == 'create-movie' || $_GET['handle'] == 'edit-movie') ? 'menu-item menu-item-active' : 'menu-item menu-item-default'; ?>">


                    <div class="menu-item-content">
                        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/1645334a3bbbbf67bb257cdcb36aa05979f059c53a4ab1b308f97b9a5bf22a2f?apiKey=a7b5919b608d4a8d87d14c0f93c1c4bc&"
                            alt="Lên lịch chiếu icon" class="menu-item-icon" />
                        <span class="menu-item-text">Danh sách yêu cầu</span>
                ...
                <div onclick="redirectTo('event-mgt')"
                    ...
                    <div class="menu-item-content">
                        ...
                        <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/1645334a3bbbbf67bb257cdcb36aa05979f059c53a4ab1b308f97b9a5bf22a2f?apiKey=a7b5919b608d4a8d87d14c0f93c1c4bc&"
                            alt="Lên lịch chiếu icon" class="menu-item-icon" />
                        <span class="menu-item-text">Danh sách sự kiện</span>

                    </div>

                </div>
                <div onclick="redirectTo('duty-mgt')"
                    class="<?php echo isset($_GET['handle']) && ($_GET['handle'] == 'duty-mgt' || $_GET['handle'] == 'create-news' || $_GET['handle'] == 'edit-news') ? 'menu-item menu-item-active' : 'menu-item menu-item-default'; ?>">
                    <div class="menu-item-content">
                        ...
                        <span class="menu-item-text">Danh sách nhiệm vụ</span>
                    </div>


                </div>

                <div onclick="redirectTo('record')"
                    class="<?php echo isset($_GET['handle']) && $_GET['handle'] == 'record' ? 'menu-item menu-item-active' : 'menu-item menu-item-default'; ?>">
                    <div class="menu-item-content">
                ...
                <div onclick="redirectTo('startup-info')"
                    class="<?php echo isset($_GET['handle']) && ($_GET['handle'] == 'startup-info' || $_GET['handle'] == 'create-food' || $_GET['handle'] == 'edit-food') ? 'menu-item menu-item-active' : 'menu-item menu-item-default'; ?>">
                    <div class="menu-item-content">
                       ...
                       bc&" alt="Quản lý đồ ăn icon" class="menu-item-icon" />
                        <span class="menu-item-text">Thông tin startup</span>
                    </div>
                ...
                if (isset($_GET['handle'])) {
                    ...
                    switch ($handle) {
                        ...
                        case 'record':
                            ...
                            break;
                        default:
                            include 'okr-mgt.php'; // Trang mặc định khi không có tham số hoặc tham số không hợp lệ
                            break;
                    }
                } else {
                    include 'okr-mgt.php'; // Trang mặc định khi không có tham số trong URL
                }
                ?>
            </div>
