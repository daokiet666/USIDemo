...
<div class='request_container'>
    ...
    <div class='information_form'>
        <form id="myForm" action="event.php" method="POST">
            ...
            <div class = "action">
                <button type="submit" style="background-color: #244585; color: var(--Shade-100, #fff);">Xác nhận tham gia</button>
                <button type="submit" style="background-color: #efeff0; color: var(--Shade-100, #fff); color: #244585">Không tham gia</button>
            </div>
        </form>
    </div>
</div>
